                      ...
                      InkWell(
                          onTap: ()async{
                            ...
                            if(datePicked!=null){
                              ...
                              petProfileWatch.ageController.text = formattedDate;
                              int age=  petProfileWatch.calculateAge(datePicked);
                              print(age);

                            }
                          },
                          child: Icon(Icons.keyboard_arrow_down,color: Color(0XFF3F434A),)),
                    ],
                  ),
